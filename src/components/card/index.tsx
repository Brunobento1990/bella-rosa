    ...
    <S.ContainerCard>
      ...
      <S.ContainerText>
        ...
        <S.ContainerTitle>
          ...
          {props.product?.size && <Title text={props.product?.size} />}
          {props.product?.color && <Title text={props.product?.color} />}
          {props.product?.pricePromotion ? (
            <>
              <Title
                text={`De R$: ${props.product.price}`}
                textDecoration="line-through"
              />
              <Title text={`por R$: ${props.product?.pricePromotion}`} />
            </>
          ) : (
